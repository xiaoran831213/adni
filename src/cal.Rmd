...
We would like to merge three GWAS wide calls for ADNI (Alzheimer’s
Disease Neuroimaging Initiative) into one genotype data.


# Introduction

By the time of 11-18-2019, ADNI have provided two sets of variant
calling:
